...
const Ears = ({earSet, color = '#929292'}) => {
    const leftTransform = [
    ...
    return (
        <g className='ears' transform='translate(8 -22)'>
            ...
            <use fill={color} width='127.9' height='151.5' x={-64} y='-75.8' transform={leftTransform[earSet]} xlinkHref='#ear' />
            <use fill={color} width='127.9' height='151.5' x={-64} y='-75.8' transform={rightTransform[earSet]} xlinkHref='#ear' />
        </g>
    );
};
